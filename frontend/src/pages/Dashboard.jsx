    ...
    <AppShell onLogout={logout}>
      <div className="card p-5 sm:p-8">
        <div className="flex flex-col gap-1 sm:gap-2 mb-6 sm:mb-8">
          <p className="text-sm font-medium text-topaz-600 uppercase tracking-wide">
            Tableau de bord
          </p>
          ...
          <p className="text-prune-600 text-sm sm:text-base">
            Vous êtes connecté à votre espace Myrokay.
          </p>
        </div>
        ...
        {isAdmin && (
          <Link
            to="/admin"
            className="mt-6 inline-flex items-center justify-center min-h-11 px-5 py-2.5
                       bg-prune-900 text-wasabi-400 font-semibold rounded-xl hover:bg-prune-800 transition-colors"
          >
            Ouvrir l&apos;administration
          </Link>
        )}

        <div className="mt-6 sm:mt-8 p-4 sm:p-5 rounded-xl bg-gradient-to-r from-wasabi-100 via-topaz-50 to-prune-100 border border-prune-100">
